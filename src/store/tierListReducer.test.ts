...
describe('tierListReducer', () => {
  ...
  describe('LOAD', () => {
    it('loads a tier list', () => {
      ...
      expect(newState.present.name).toBe('Loaded Tier List');
    });
  });
  ...
  describe('SAVE_REQUEST', () => {
    it('handles save request (no state change)', () => {
      ...
      expect(newState.present).toBe(state.present);
    });
  });
  ...
  describe('DRAG_MOVE', () => {
    it('does not modify state on drag move', () => {
      ...
      const newState = tierListReducer(state, {
        type: 'DRAG_MOVE',
        payload: { type: 'item', id: 'test-id', over: null },
      });
  ...
  describe('DRAG_END', () => {
    it('does not modify state on drag end', () => {
      ...
      const newState = tierListReducer(state, {
        type: 'DRAG_END',
        payload: { type: 'item', id: 'test-id', over: null, dropped: false },
      });
