...
[![codecov](https://codecov.io/gh/remarkablemark/tierlist/graph/badge.svg?token=X4KqsMmJ1J)](https://codecov.io/gh/remarkablemark/tierlist)
...
```sh
git clone https://github.com/remarkablemark/tierlist.git
cd tierlist
```
